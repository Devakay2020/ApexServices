/* ------------------------------------------------------------------------------------------------------------------------------------ */
/* C0632    Delete Panoptic Entities                                                                                                    */
/* ------------------------------------------------------------------------------------------------------------------------------------ */
...
{
    public class RiskScoringDeleteEntity : IServiceCall
    {
        ...
        public JsonResponse Process(object data)
        {
            ...
            var requestData = new ApexServices.RiskScoringDeleteEntity.SFDCRiskRequests();
            ...
            List<ApexServices.RiskScoringDeleteEntity.SFDCRiskRequestsRiskScoreRequest> riskScoreRequestList = new List<ApexServices.RiskScoringDeleteEntity.SFDCRiskRequestsRiskScoreRequest>();
           
            foreach (Data.RiskScoreRequest req in riskData.RiskScoreRequest)
            {
                ApexServices.RiskScoringDeleteEntity.SFDCRiskRequestsRiskScoreRequest riskReq = new ApexServices.RiskScoringDeleteEntity.SFDCRiskRequestsRiskScoreRequest();
            ...
            var client = new ApexServices.RiskScoringDeleteEntity.Bank_Biztalk_RiskScoring_orcProcessPanopticDeleteEntity_ReceiveSFDCRequestPortClient();
